...
機能: ユーザ登録画面
  ...
  シナリオ: 同じ社員番号のユーザが存在するときユーザ登録が失敗する
    ...
    ならば 画面遷移せず (非同期)
    かつ アラート(.alert-message) 欄に 社員番号 を含む表示がされる
  ...
  シナリオ: 名前が空のときユーザ登録が失敗する
    ...
    ならば 画面遷移せず (非同期)
    かつ アラート(.alert-message) 欄に 名前 を含む表示がされる
  ...
  シナリオ: 部署が選択されていないときユーザ登録が失敗する
    ...
    ならば 画面遷移せず (非同期)
    かつ アラート(.alert-message) 欄に 所属 を含む表示がされる
  ...
  シナリオ: 入社年月日が空のときユーザ登録が失敗する
    ...
    ならば 画面遷移せず (非同期)
    かつ アラート(.alert-message) 欄に 入社年月日 を含む表示がされる
  ...
  シナリオ: パスワードが空のときユーザ登録が失敗する
    ...
    ならば 画面遷移せず (非同期)
    かつ アラート(.alert-message) 欄に パスワード を含む表示がされる
